...
public class Message {
    ...
    public Message hover(String message) {
        text.withStyle(s -> s.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.nullToEmpty(message))));
        return this;
    }

    public Message click(String message) {
        text.withStyle(s -> s.withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, message)));
        return this;
    }
    ...
    public Message prependFaction(Faction faction) {
        text = new Message("")
                .add(new Message(faction.getColor().toString() + ChatFormatting.BOLD + faction.getName()).hover(faction.getDescription()))
                .filler("»")
                .raw()
                .append(text);
        return this;
    ...
    public Message filler(String symbol) {
        text.append(Component.nullToEmpty(" " + ChatFormatting.RESET + ChatFormatting.DARK_GRAY + symbol + ChatFormatting.RESET + " "));
        return this;
    }
